...
object MacroThemes extends TraitMacro {
  ...
  private[macros] val dark: ThemePalette = ThemePalette(
    ...
    values = Map(
      ...
      "--color-link-hover-bg" -> "#263854",
      "--color-link-schema" -> "#b7c7ff",
      ...
      "--color-surface-panel" -> "linear-gradient(135deg, #20203a 0%, #24304a 100%)",
      "--color-border" -> "#444466",
      "--color-border-subtle" -> "#383852",
      "--color-muted" -> "#b5b5c8",
      "--color-muted-strong" -> "#d5d5e8",
      "--color-code-bg" -> "#0d0d1a",
      "--color-code-text" -> "#cccccc",
      "--color-code-border" -> "#555588",
      "--color-code-link" -> "#6da3f8",
      "--color-blockquote-bg" -> "#1e1e3a",
      "--color-blockquote-border" -> "#555588",
      ...
      "--color-navbar-border" -> "rgba(100, 100, 150, 0.3)",
      "--color-navbar-shadow" -> "rgba(0, 0, 0, 0.35)",
      "--color-navbar-text" -> "#e0e0e0",
      "--color-navbar-home" -> "#8cb4ff",
      "--color-navbar-menu-bg" -> "#20203a",
      "--color-navbar-text-shadow" -> "none",
      "--color-input-bg" -> "#20203a",
      "--color-input-border" -> "#444466",
      "--color-focus-ring" -> "#6da3f8",
      ...
      "--color-table-border" -> "#383852",
      "--color-table-header-bg" -> "rgba(100, 100, 150, 0.22)",
      "--color-table-row-alt-bg" -> "rgba(255, 255, 255, 0.03)",
      "--color-table-row-hover-bg" -> "rgba(109, 163, 248, 0.12)",
      "--color-percent-track" -> "#383852",
      "--color-percent-bar" -> "#6da3f8",
      "--color-percent-label" -> "#ffffff",
      "--color-adjacent-placeholder-bg" -> "linear-gradient(135deg, #20203a 0%, #1a1a2e 100%)",
      "--color-adjacent-placeholder-border" -> "#444466",
      "--color-adjacent-placeholder-text" -> "#d5d5e8",
      "--color-adjacent-placeholder-icon" -> "#8cb4ff",
      "--color-adjacent-placeholder-muted" -> "#b5b5c8",
      "--color-adjacent-hud-bg" -> "rgba(32, 32, 58, 0.78)",
      "--color-adjacent-hud-border" -> "#444466",
      "--color-adjacent-hud-shadow" -> "rgba(0, 0, 0, 0.35)",
      "--color-adjacent-hud-text" -> "#e0e0e0",
      "--color-adjacent-hud-title" -> "#d5d5e8",
      "--color-adjacent-hud-action-bg" -> "#252542",
      "--color-adjacent-hud-action-text" -> "#e0e0e0",
      "--color-adjacent-hud-action-active-bg" -> "#6da3f8",
      "--color-adjacent-hud-action-active-text" -> "#0d0d1a",
      "--color-adjacent-dot-root" -> "#8cb4ff",
      "--color-adjacent-dot-hop1" -> "#6da3f8",
      "--color-adjacent-dot-hop2" -> "#b5b5c8",
      "--color-kanban-bg" -> "linear-gradient(135deg, #18182c 0%, #20203a 100%)",
      "--color-kanban-column-bg" -> "#20203a",
      "--color-kanban-card-bg" -> "#252542",
      "--color-kanban-border" -> "#444466",
      "--color-kanban-muted" -> "#b5b5c8",
      "--color-kanban-text" -> "#e0e0e0",
      "--color-kanban-primary" -> "#6da3f8",
