    ...
    override def result(): String = {
      ...
      if (arrayBufferHeading.length > 6)
        arrayBuffer.insert(0,
          """<div class="toc" data-default-collapsed-mobile="true"><button type="button" class="tocToggle" aria-expanded="true"><i class="fas fa-chevron-down"></i></button><div class="tocBody">""" +
