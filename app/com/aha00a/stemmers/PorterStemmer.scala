...
//noinspection TypeAnnotation,RemoveRedundantReturn,ScalaUnnecessarySemicolon,ReplaceToWithUntil,ScalaUnnecessaryParentheses,ScalaUnusedSymbol,VarCouldBeVal,SpellCheckingInspection
class PorterStemmer {
