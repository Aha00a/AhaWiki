...
object GoogleSpreadsheetApi {
  def readSpreadSheet(id: String, sheetName: String)(implicit configuration:Configuration, wSClient: WSClient, executionContext: ExecutionContext): Future[Seq[Seq[String]]] = {
    wSClient
