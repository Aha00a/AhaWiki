...
function SiteDetailPage() {
  ...
  return /* @__PURE__ */ React14.createElement(Card7, { radius: "md", padding: "lg" }, /* @__PURE__ */ React14.createElement(Group10, { justify: "space-between", mb: "md" }, /* @__PURE__ */ React14.createElement(Title8, { order: 3 }, "Page"), /* @__PURE__ */ React14.createElement(Badge9, { color: "indigo", variant: "light" }, count, " rows")), /* @__PURE__ */ React14.createElement(Group10, { mb: "md", align: "flex-end" }, /* @__PURE__ */ React14.createElement("input", { type: "text", value: searchInput, onChange: (e) => setSearchInput(e.target.value), placeholder: "page name, image", style: { border: "1px solid #ced4da", borderRadius: 6, padding: "6px 10px" } }), /* @__PURE__ */ React14.createElement(Button5, { variant: "filled", onClick: () => {
    setMetaPage(1);
